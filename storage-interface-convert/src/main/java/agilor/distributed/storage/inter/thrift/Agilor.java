...
public class Agilor {
  ...
  public interface Iface {
    ...
    public boolean AddDevice(DEVICE device) throws TException;

    public boolean DeleteDevice(String deviceName) throws TException;

    public boolean ModifyDevice(DEVICE device) throws TException;

    public long QueryDeviceInfo() throws TException;

    public DEVICE EnumDeviceInfo(long hRecordset) throws TException;

    public List<DEVICE> GetAllDevices() throws TException;

    public long TagCountByDevice(String deviceName) throws TException;

    public long QuerySnapshots(String tagNames, int tagCount) throws TException;

    public TAGVAL GetNextTagValue(long hRecordset, boolean isRemoved) throws TException;

    public long QueryTagHistory(String tagName, long startTime, long endTime, long step) throws TException;

    public TAGVAL GetAggregateValue(long hRecordset, AGGREGATE ag, boolean isRemoved) throws TException;

    public long QueryTagsbyDevice(String deviceName) throws TException;

    public String EnumTagName(long hRecordset) throws TException;

    public String GetTagNamebyId(long tagId) throws TException;

    public long SetValue(TAGVAL value) throws TException;

    public long SetValues(List<TAGVAL> values) throws TException;

    public long RemoveTag(long tagId) throws TException;

    public TAGNODE GetTagInfo(String tagName) throws TException;

    public long AddNewTag(TAGNODE node, boolean isOverwrite) throws TException;

    public TAGNODE EnumNextTag(long hwnd) throws TException;

    public long SubscribeTags(String tagNames) throws TException;

    public TAGVAL GetSubTagValue() throws TException;

    public long UnSubscribeTags(String tagNames) throws TException;

    public long UnSubscribeAll() throws TException;
  ...
  public interface AsyncIface {
    ...
    public void EnumDeviceInfo(long hRecordset, AsyncMethodCallback resultHandler) throws TException;
    ...
    public void GetNextTagValue(long hRecordset, boolean isRemoved, AsyncMethodCallback resultHandler) throws TException;

    public void QueryTagHistory(String tagName, long startTime, long endTime, long step, AsyncMethodCallback resultHandler) throws TException;

    public void GetAggregateValue(long hRecordset, AGGREGATE ag, boolean isRemoved, AsyncMethodCallback resultHandler) throws TException;

    public void QueryTagsbyDevice(String deviceName, AsyncMethodCallback resultHandler) throws TException;

    public void EnumTagName(long hRecordset, AsyncMethodCallback resultHandler) throws TException;

    public void GetTagNamebyId(long tagId, AsyncMethodCallback resultHandler) throws TException;
    ...
    public void RemoveTag(long tagId, AsyncMethodCallback resultHandler) throws TException;
    ...
    public void EnumNextTag(long hwnd, AsyncMethodCallback resultHandler) throws TException;

    public void SubscribeTags(String tagNames, AsyncMethodCallback resultHandler) throws TException;

    public void GetSubTagValue(AsyncMethodCallback resultHandler) throws TException;

    public void UnSubscribeTags(String tagNames, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean recv_AddDevice() throws TException
    {
    ...
    public boolean recv_DeleteDevice() throws TException
    {
    ...
    public long recv_QueryDeviceInfo() throws TException
    {
    ...
    public void send_EnumDeviceInfo(long hRecordset) throws TException
    {
    ...
    public DEVICE recv_EnumDeviceInfo() throws TException
    {
    ...
    public long recv_TagCountByDevice() throws TException
    {
    ...
    public long recv_QuerySnapshots() throws TException
    {
    ...
    public void send_GetNextTagValue(long hRecordset, boolean isRemoved) throws TException
    {
    ...
    public TAGVAL recv_GetNextTagValue() throws TException
    {
    ...
    public void send_QueryTagHistory(String tagName, long startTime, long endTime, long step) throws TException
    {
    ...
    public long recv_QueryTagHistory() throws TException
    {
    ...
    public void send_GetAggregateValue(long hRecordset, AGGREGATE ag, boolean isRemoved) throws TException
    {
    ...
    public long recv_QueryTagsbyDevice() throws TException
    {
    ...
    public void send_EnumTagName(long hRecordset) throws TException
    {
    ...
    public String recv_EnumTagName() throws TException
    {
    ...
    public void send_GetTagNamebyId(long tagId) throws TException
    {
    ...
    public long recv_SetValue() throws TException
    {
    ...
    public long recv_SetValues() throws TException
    {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "SetValues failed: unknown result");
    }
    ...
    public void send_RemoveTag(long tagId) throws TException
    {
    ...
    public long recv_RemoveTag() throws TException
    {
    ...
    public long recv_AddNewTag() throws TException
    {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "AddNewTag failed: unknown result");
    }
    ...
    public void send_EnumNextTag(long hwnd) throws TException
    {
    ...
    public TAGNODE recv_EnumNextTag() throws TException
    {
    ...
    public long SubscribeTags(String tagNames) throws TException
    {
      send_SubscribeTags(tagNames);
      return recv_SubscribeTags();
    }

    public void send_SubscribeTags(String tagNames) throws TException
    {
    ...
    public long recv_SubscribeTags() throws TException
    {
    ...
    public long UnSubscribeTags(String tagNames) throws TException
    {
      send_UnSubscribeTags(tagNames);
      return recv_UnSubscribeTags();
    }

    public void send_UnSubscribeTags(String tagNames) throws TException
    {
    ...
    public long recv_UnSubscribeTags() throws TException
    {
    ...
    public long recv_UnSubscribeAll() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class EnumDeviceInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long hRecordset;
      public EnumDeviceInfo_call(long hRecordset, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class GetNextTagValue_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public GetNextTagValue_call(long hRecordset, boolean isRemoved, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hRecordset = hRecordset;
    ...
    public static class QueryTagHistory_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long step;
      public QueryTagHistory_call(String tagName, long startTime, long endTime, long step, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class GetAggregateValue_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private boolean isRemoved;
      public GetAggregateValue_call(long hRecordset, AGGREGATE ag, boolean isRemoved, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hRecordset = hRecordset;
        this.ag = ag;
        this.isRemoved = isRemoved;
    ...
    public static class EnumTagName_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long hRecordset;
      public EnumTagName_call(long hRecordset, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hRecordset = hRecordset;
      }
    ...
    public static class GetTagNamebyId_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long tagId;
      public GetTagNamebyId_call(long tagId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tagId = tagId;
      }
    ...
    public static class SetValues_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public long getResult() throws TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_SetValues();
      }
    }
    ...
    public static class RemoveTag_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long tagId;
      public RemoveTag_call(long tagId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tagId = tagId;
      }
    ...
    public static class AddNewTag_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public long getResult() throws TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_AddNewTag();
      }
    }
    ...
    public static class EnumNextTag_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long hwnd;
      public EnumNextTag_call(long hwnd, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hwnd = hwnd;
      }
    ...
    public void SubscribeTags(String tagNames, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      SubscribeTags_call method_call = new SubscribeTags_call(tagNames, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class SubscribeTags_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String tagNames;
      public SubscribeTags_call(String tagNames, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tagNames = tagNames;
      }
    ...
    public void UnSubscribeTags(String tagNames, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      UnSubscribeTags_call method_call = new UnSubscribeTags_call(tagNames, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class UnSubscribeTags_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String tagNames;
      public UnSubscribeTags_call(String tagNames, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tagNames = tagNames;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class DeleteDevice<I extends Iface> extends org.apache.thrift.ProcessFunction<I, DeleteDevice_args> {
      ...
      public DeleteDevice_result getResult(I iface, DeleteDevice_args args) throws TException {
        DeleteDevice_result result = new DeleteDevice_result();
        result.success = iface.DeleteDevice(args.deviceName);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class SetValue<I extends Iface> extends org.apache.thrift.ProcessFunction<I, SetValue_args> {
      ...
      public SetValue_result getResult(I iface, SetValue_args args) throws TException {
        SetValue_result result = new SetValue_result();
        result.success = iface.SetValue(args.value);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class SetValues<I extends Iface> extends org.apache.thrift.ProcessFunction<I, SetValues_args> {
      ...
      public SetValues_result getResult(I iface, SetValues_args args) throws TException {
        SetValues_result result = new SetValues_result();
        result.success = iface.SetValues(args.values);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class RemoveTag<I extends Iface> extends org.apache.thrift.ProcessFunction<I, RemoveTag_args> {
      ...
      public RemoveTag_result getResult(I iface, RemoveTag_args args) throws TException {
        RemoveTag_result result = new RemoveTag_result();
        result.success = iface.RemoveTag(args.tagId);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class AddNewTag<I extends Iface> extends org.apache.thrift.ProcessFunction<I, AddNewTag_args> {
      ...
      public AddNewTag_result getResult(I iface, AddNewTag_args args) throws TException {
        AddNewTag_result result = new AddNewTag_result();
        result.success = iface.AddNewTag(args.node, args.isOverwrite);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class SubscribeTags<I extends Iface> extends org.apache.thrift.ProcessFunction<I, SubscribeTags_args> {
      ...
      public SubscribeTags_result getResult(I iface, SubscribeTags_args args) throws TException {
        SubscribeTags_result result = new SubscribeTags_result();
        result.success = iface.SubscribeTags(args.tagNames);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    public static class UnSubscribeTags<I extends Iface> extends org.apache.thrift.ProcessFunction<I, UnSubscribeTags_args> {
      ...
      public UnSubscribeTags_result getResult(I iface, UnSubscribeTags_args args) throws TException {
        UnSubscribeTags_result result = new UnSubscribeTags_result();
        result.success = iface.UnSubscribeTags(args.tagNames);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class AddDevice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, AddDevice_args, Boolean> {
      public AddDevice() {
        super("AddDevice");
      }
      ...
      public void start(I iface, AddDevice_args args, AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.AddDevice(args.device,resultHandler);
      }
    }

    public static class DeleteDevice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, DeleteDevice_args, Boolean> {
      public DeleteDevice() {
        super("DeleteDevice");
      }
      ...
      public void start(I iface, DeleteDevice_args args, AsyncMethodCallback<Boolean> resultHandler) throws TException {
    ...
    public static class QueryDeviceInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, QueryDeviceInfo_args, Long> {
      public QueryDeviceInfo() {
        super("QueryDeviceInfo");
      }
      ...
      public void start(I iface, QueryDeviceInfo_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class TagCountByDevice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, TagCountByDevice_args, Long> {
      public TagCountByDevice() {
        super("TagCountByDevice");
      }
      ...
      public void start(I iface, TagCountByDevice_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.TagCountByDevice(args.deviceName,resultHandler);
      }
    }

    public static class QuerySnapshots<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, QuerySnapshots_args, Long> {
      public QuerySnapshots() {
        super("QuerySnapshots");
      }
      ...
      public void start(I iface, QuerySnapshots_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class QueryTagHistory<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, QueryTagHistory_args, Long> {
      public QueryTagHistory() {
        super("QueryTagHistory");
      }
      ...
      public void start(I iface, QueryTagHistory_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class QueryTagsbyDevice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, QueryTagsbyDevice_args, Long> {
      public QueryTagsbyDevice() {
        super("QueryTagsbyDevice");
      }
      ...
      public void start(I iface, QueryTagsbyDevice_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class SetValue<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, SetValue_args, Long> {
      public SetValue() {
        super("SetValue");
      }
      ...
      public void start(I iface, SetValue_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.SetValue(args.value,resultHandler);
      }
    }

    public static class SetValues<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, SetValues_args, Long> {
      public SetValues() {
        super("SetValues");
      }
      ...
      public void start(I iface, SetValues_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.SetValues(args.values,resultHandler);
      }
    }

    public static class RemoveTag<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, RemoveTag_args, Long> {
      public RemoveTag() {
        super("RemoveTag");
      }
      ...
      public void start(I iface, RemoveTag_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class AddNewTag<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, AddNewTag_args, Long> {
      public AddNewTag() {
        super("AddNewTag");
      }
      ...
      public void start(I iface, AddNewTag_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
    ...
    public static class SubscribeTags<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, SubscribeTags_args, Long> {
      public SubscribeTags() {
        super("SubscribeTags");
      }
      ...
      public void start(I iface, SubscribeTags_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.SubscribeTags(args.tagNames,resultHandler);
      }
    }
    ...
    public static class UnSubscribeTags<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, UnSubscribeTags_args, Long> {
      public UnSubscribeTags() {
        super("UnSubscribeTags");
      }
      ...
      public void start(I iface, UnSubscribeTags_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.UnSubscribeTags(args.tagNames,resultHandler);
      }
    }

    public static class UnSubscribeAll<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, UnSubscribeAll_args, Long> {
      public UnSubscribeAll() {
        super("UnSubscribeAll");
      }
      ...
      public void start(I iface, UnSubscribeAll_args args, AsyncMethodCallback<Long> resultHandler) throws TException {
...
;
  ...
  public static class QueryDeviceInfo_result implements org.apache.thrift.TBase<QueryDeviceInfo_result, QueryDeviceInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<QueryDeviceInfo_result>   {
    ...
    public QueryDeviceInfo_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class EnumDeviceInfo_args implements org.apache.thrift.TBase<EnumDeviceInfo_args, EnumDeviceInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<EnumDeviceInfo_args>   {
    ...
    private static final org.apache.thrift.protocol.TField H_RECORDSET_FIELD_DESC = new org.apache.thrift.protocol.TField("hRecordset", org.apache.thrift.protocol.TType.I64, (short)1);
    ...
    public long hRecordset; // required
    ...
    public long getHRecordset() {
      return this.hRecordset;
    }

    public EnumDeviceInfo_args setHRecordset(long hRecordset) {
      this.hRecordset = hRecordset;
      setHRecordsetIsSet(true);
      return this;
    }
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case H_RECORDSET:
        return Long.valueOf(getHRecordset());
    ...
    private static class EnumDeviceInfo_argsStandardScheme extends StandardScheme<EnumDeviceInfo_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, EnumDeviceInfo_args struct) throws TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // H_RECORDSET
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.hRecordset = iprot.readI64();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, EnumDeviceInfo_args struct) throws TException {
        ...
        oprot.writeI64(struct.hRecordset);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
...
;
  ...
  public static class TagCountByDevice_result implements org.apache.thrift.TBase<TagCountByDevice_result, TagCountByDevice_result._Fields>, java.io.Serializable, Cloneable, Comparable<TagCountByDevice_result>   {
    ...
    public TagCountByDevice_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class QuerySnapshots_result implements org.apache.thrift.TBase<QuerySnapshots_result, QuerySnapshots_result._Fields>, java.io.Serializable, Cloneable, Comparable<QuerySnapshots_result>   {
    ...
    public QuerySnapshots_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class GetNextTagValue_args implements org.apache.thrift.TBase<GetNextTagValue_args, GetNextTagValue_args._Fields>, java.io.Serializable, Cloneable, Comparable<GetNextTagValue_args>   {
    ...
    public GetNextTagValue_args setHRecordset(long hRecordset) {
      this.hRecordset = hRecordset;
      setHRecordsetIsSet(true);
      return this;
    }
  ...
  public static class QueryTagHistory_args implements org.apache.thrift.TBase<QueryTagHistory_args, QueryTagHistory_args._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTagHistory_args>   {
    ...
    private static final org.apache.thrift.protocol.TField STEP_FIELD_DESC = new org.apache.thrift.protocol.TField("step", org.apache.thrift.protocol.TType.I64, (short)4);
    ...
    public QueryTagHistory_args setStartTime(long startTime) {
      this.startTime = startTime;
      setStartTimeIsSet(true);
      return this;
    }
    ...
    public QueryTagHistory_args setEndTime(long endTime) {
      this.endTime = endTime;
      setEndTimeIsSet(true);
      return this;
    }
    ...
    public QueryTagHistory_args setStep(long step) {
      this.step = step;
      setStepIsSet(true);
      return this;
    }
  ...
  public static class QueryTagHistory_result implements org.apache.thrift.TBase<QueryTagHistory_result, QueryTagHistory_result._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTagHistory_result>   {
    ...
    public QueryTagHistory_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class GetAggregateValue_args implements org.apache.thrift.TBase<GetAggregateValue_args, GetAggregateValue_args._Fields>, java.io.Serializable, Cloneable, Comparable<GetAggregateValue_args>   {
    ...
    public GetAggregateValue_args setHRecordset(long hRecordset) {
      this.hRecordset = hRecordset;
      setHRecordsetIsSet(true);
      return this;
    }
  ...
  public static class QueryTagsbyDevice_result implements org.apache.thrift.TBase<QueryTagsbyDevice_result, QueryTagsbyDevice_result._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTagsbyDevice_result>   {
    ...
    public QueryTagsbyDevice_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class EnumTagName_args implements org.apache.thrift.TBase<EnumTagName_args, EnumTagName_args._Fields>, java.io.Serializable, Cloneable, Comparable<EnumTagName_args>   {
    ...
    public EnumTagName_args setHRecordset(long hRecordset) {
      this.hRecordset = hRecordset;
      setHRecordsetIsSet(true);
      return this;
    }
  ...
  public static class GetTagNamebyId_args implements org.apache.thrift.TBase<GetTagNamebyId_args, GetTagNamebyId_args._Fields>, java.io.Serializable, Cloneable, Comparable<GetTagNamebyId_args>   {
    ...
    public GetTagNamebyId_args setTagId(long tagId) {
      this.tagId = tagId;
      setTagIdIsSet(true);
      return this;
    }
  ...
  public static class SetValue_result implements org.apache.thrift.TBase<SetValue_result, SetValue_result._Fields>, java.io.Serializable, Cloneable, Comparable<SetValue_result>   {
    ...
    public SetValue_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class SetValues_result implements org.apache.thrift.TBase<SetValues_result, SetValues_result._Fields>, java.io.Serializable, Cloneable, Comparable<SetValues_result>   {
    ...
    public SetValues_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class RemoveTag_result implements org.apache.thrift.TBase<RemoveTag_result, RemoveTag_result._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveTag_result>   {
    ...
    public RemoveTag_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class AddNewTag_result implements org.apache.thrift.TBase<AddNewTag_result, AddNewTag_result._Fields>, java.io.Serializable, Cloneable, Comparable<AddNewTag_result>   {
    ...
    public AddNewTag_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
  ...
  public static class EnumNextTag_args implements org.apache.thrift.TBase<EnumNextTag_args, EnumNextTag_args._Fields>, java.io.Serializable, Cloneable, Comparable<EnumNextTag_args>   {
    ...
    private static final org.apache.thrift.protocol.TField HWND_FIELD_DESC = new org.apache.thrift.protocol.TField("hwnd", org.apache.thrift.protocol.TType.I64, (short)1);
    ...
    public EnumNextTag_args setHwnd(long hwnd) {
      this.hwnd = hwnd;
      setHwndIsSet(true);
      return this;
    }
  ...
  public static class SubscribeTags_result implements org.apache.thrift.TBase<SubscribeTags_result, SubscribeTags_result._Fields>, java.io.Serializable, Cloneable, Comparable<SubscribeTags_result>   {
    ...
    public SubscribeTags_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
...
;
  ...
  public static class UnSubscribeTags_result implements org.apache.thrift.TBase<UnSubscribeTags_result, UnSubscribeTags_result._Fields>, java.io.Serializable, Cloneable, Comparable<UnSubscribeTags_result>   {
    ...
    public UnSubscribeTags_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
...
;
  ...
  public static class UnSubscribeAll_result implements org.apache.thrift.TBase<UnSubscribeAll_result, UnSubscribeAll_result._Fields>, java.io.Serializable, Cloneable, Comparable<UnSubscribeAll_result>   {
    ...
    public UnSubscribeAll_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
